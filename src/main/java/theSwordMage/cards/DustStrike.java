...
public class DustStrike extends AbstractDynamicCard {

    public static final String ID = SwordMageMod.makeID(DustStrike.class.getSimpleName());
    public static final String IMG = makeCardPath("DustStrike.png");
    ...
    private static final String ID_TO_FOCUS = EarthenSwordOrb.ORB_ID;
