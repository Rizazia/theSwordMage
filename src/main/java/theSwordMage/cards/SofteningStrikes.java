...
public class SofteningStrikes extends AbstractDynamicCard {

    public static final String ID = SwordMageMod.makeID(SofteningStrikes.class.getSimpleName());
    public static final String IMG = makeCardPath("SofteningStrikes.png");
