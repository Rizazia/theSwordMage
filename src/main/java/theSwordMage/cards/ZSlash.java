...
public class ZSlash extends AbstractDynamicCard {

    public static final String ID = SwordMageMod.makeID(ZSlash.class.getSimpleName());
    public static final String IMG = makeCardPath("ZSlash.png");
