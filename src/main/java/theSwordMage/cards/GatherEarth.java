...
public class GatherEarth extends AbstractDynamicCard {

    public static final String ID = SwordMageMod.makeID(GatherEarth.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("GatherEarth.png");
